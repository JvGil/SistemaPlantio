...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	<title>Alteração de insumos</title>
</head>
<body>
	...
	<f:view>
		...
		<h:form>
			<center>
				<h1 class="h1">Alteração de insumos</h1>
				...
				<h:panelGrid columns="2">
					...
					<h:inputText value="#{insumoBacking.tipo}" maxlength="45" styleClass="textFields" readonly="true"/>
				</h:panelGrid>

				<h:panelGrid columns="2">
					<h:outputText value="Nome:" styleClass="labelNome"/>
					<h:inputText value="#{insumoBacking.nome}" maxlength="45" styleClass="textFields" readonly="true"/>
				</h:panelGrid>
				...
				<h:panelGrid columns="2">
					<h:commandButton value="Salvar" action="#{insumoBacking.alterar}" />
