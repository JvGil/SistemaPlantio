...
<body>
	...
	<f:view>
		...
		<h:form>
			<center>
				<h1 class="h1">Cadastro de Fazenda</h1>
				...
				<h:panelGrid columns="2">
					...
					<h:inputText value="#{fazendaBacking.nome}" maxlength="45" styleClass="textFields"/>
				</h:panelGrid>
				...
				<h:panelGrid columns="2">
					...
					<h:inputText value="#{fazendaBacking.areaTotal}" maxlength="45" styleClass="textFields"/>
				</h:panelGrid>

				<h:panelGrid columns="2">
					<h:commandButton value="Salvar" action="#{fazendaBacking.salvar}" />
